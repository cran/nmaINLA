...
#' in an intuitive way (Guenhan et al, 2018). Currently, contrast-based network
...
#' by running: install.packages("INLA",repos=c(getOption("repos"),
...
#' @author Burak Kuersad Guenhan <burakgunhan@gmail.com>
#' @docType package
#' @name nmaINLA
NULL
